...
/// <summary>
/// Standalone file-backed implementation of IPluginSettingsStore for Rider local runner testing.
/// Persists HighScore and user preferences to snake.runner.settings.json without requiring FryPDF or any host services.
/// </summary>
public class StandaloneSettingsStore : IPluginSettingsStore
{
    ...
    {
        _filePath = filePath ?? Path.Combine(AppContext.BaseDirectory, "snake.runner.settings.json");
        _data = LoadFromFile();
    }
