...
"""";
    ...
    public static IHighlightingDefinition GetLightTheme()
    {
        if (_lightDefinition != null) return _lightDefinition;

        lock (_lock)
        {
            if (_lightDefinition != null) return _lightDefinition;

            using var reader = new XmlTextReader(new StringReader(LightXshdXml));
            _lightDefinition = HighlightingLoader.Load(reader, HighlightingManager.Instance);

            HighlightingManager.Instance.RegisterHighlighting("C# Light", [".cs"], _lightDefinition);

            return _lightDefinition;
        }
    }

    private const string LightXshdXml = $$$$""""
<SyntaxDefinition name="C# Light" extensions=".cs" xmlns="http://icsharpcode.net/sharpdevelop/syntaxdefinition/2008">
	<!-- Modern VS Code Light+ Syntax Colors -->
	...
	<Color name="StringInterpolation" foreground="#001080" exampleText="string text = $&quot;Hello, {name}!&quot;"/>
	<Color name="Char" foreground="#A31515" exampleText="char linefeed = '\n';"/>
	<Color name="Preprocessor" foreground="#AF00DB" exampleText="#region Title" />
	<Color name="Punctuation" foreground="#000000" exampleText="a(b.c);" />
	<Color name="ValueTypeKeywords" foreground="#0000FF" exampleText="bool b = true;" />
	<Color name="ReferenceTypeKeywords" foreground="#267F99" exampleText="object o;" />
	<Color name="MethodCall" foreground="#795E26" exampleText="o.ToString();"/>
	<Color name="NumberLiteral" foreground="#098658" exampleText="3.1415f"/>
	<Color name="ThisOrBaseReference" foreground="#0000FF" exampleText="this.Do(); base.Do();"/>
	<Color name="NullOrValueKeywords" foreground="#0000FF" exampleText="if (value == null)"/>
	<Color name="Keywords" foreground="#AF00DB" exampleText="if (a) {} else {}"/>
	<Color name="GotoKeywords" foreground="#AF00DB" exampleText="continue; return null;"/>
	<Color name="ContextKeywords" foreground="#0000FF" exampleText="var a = from x in y select z;"/>
	<Color name="ExceptionKeywords" foreground="#AF00DB" exampleText="try {} catch {} finally {}"/>
	<Color name="CheckedKeyword" foreground="#AF00DB" exampleText="checked {}"/>
	<Color name="UnsafeKeywords" foreground="#AF00DB" exampleText="unsafe { fixed (..) {} }"/>
	<Color name="OperatorKeywords" foreground="#0000FF" exampleText="public static implicit operator..."/>
	<Color name="ParameterModifiers" foreground="#0000FF" exampleText="(ref int a, params int[] b)"/>
	<Color name="Modifiers" foreground="#0000FF" exampleText="static readonly int a;"/>
	<Color name="Visibility" foreground="#0000FF" exampleText="public override void ToString();"/>
	<Color name="NamespaceKeywords" foreground="#AF00DB" exampleText="namespace A.B { using System; }"/>
	<Color name="GetSetAddRemove" foreground="#0000FF" exampleText="int Prop { get; set; }"/>
	<Color name="TrueFalse" foreground="#0000FF" exampleText="b = false; a = true;" />
	<Color name="TypeKeywords" foreground="#267F99" exampleText="if (x is int) { a = x as int; type = typeof(int); size = sizeof(int); c = new object(); }" />
	<Color name="SemanticKeywords" foreground="#AF00DB" exampleText="if (args == null) throw new ArgumentNullException(nameof(args));" />
