...
/// Persists preferences to telemetry.runner.settings.json without requiring FryPDF or any host services.
/// </summary>
public class StandaloneSettingsStore : IPluginSettingsStore
{
    ...
    {
        _filePath = filePath ?? Path.Combine(AppContext.BaseDirectory, "telemetry.runner.settings.json");
        _data = LoadFromFile();
    }
