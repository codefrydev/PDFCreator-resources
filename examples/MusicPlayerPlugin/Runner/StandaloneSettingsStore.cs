...
/// Persists the playlist, volume, and repeat mode to musicplayer.runner.settings.json without
/// requiring FryPDF or any host services.
/// </summary>
public class StandaloneSettingsStore : IPluginSettingsStore
{
    ...
    {
        _filePath = filePath ?? Path.Combine(AppContext.BaseDirectory, "musicplayer.runner.settings.json");
        _data = LoadFromFile();
    }
