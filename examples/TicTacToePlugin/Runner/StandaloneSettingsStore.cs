...
/// Persists preferences to tictactoe.runner.settings.json without requiring FryPDF or any host services.
/// </summary>
public class StandaloneSettingsStore : IPluginSettingsStore
{
    ...
    {
        _filePath = filePath ?? Path.Combine(AppContext.BaseDirectory, "tictactoe.runner.settings.json");
        _data = LoadFromFile();
    }
